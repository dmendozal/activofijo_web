...
<div class="col-lg-12 col-12 mb-20">
    ...
    <form action="{{route('asignacion.update',$user->id)}}" method="POST" enctype="multipart/from-data"
            ...
            <table class="table table-bordered data-table data-table-default">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->asignado==1)
                            <center> <label class="adomx-checkbox-2 success"><input type="checkbox" name="activos[]"
                                        value="{{$item->idactivo}}" checked> <i class="icon"></i></label></center>
                            @else
                            <center> <label class="adomx-checkbox-2 success"><input type="checkbox" name="activos[]"
                                        value="{{$item->idactivo}}"> <i class="icon"></i></label></center>
                            @endif
                        </td>
                    </tr>
                    @endforeach
