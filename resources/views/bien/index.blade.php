...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="button button-success button-sm" href="{{route('bien.create')}}">
            Registrar Bien
        </a>
    </div>
</div>
                            ...
                            <tr data-entry-id="{{ $key }}">
                                ...
                                <td>
                                    <a class="button button-primary button-sm"
                                        href="{{ route('bien.show', $bien->idbien) }}">
                                        Mostrar
                                    </a>
                                    <a class="button button-info button-sm"
                                        href="{{ route('bien.edit', $bien->idbien) }}">
                                        Editar
                                    </a>
                                    <form action="{{ route('bien.destroy', $bien->idbien) }}" method="POST"
