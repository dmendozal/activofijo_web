( function ( $ )
{
    ...
    function customizer ()
    {
        ...
        $cusHtml += '<label class="adomx-switch primary toggle-dark"><input type="checkbox" id="isDarkio"  onclick="_cambiarSidebar(12)" > <i class="lever"></i> <span class="text">Version Dark</span></label>';
        $cusHtml += '</div>';
        $cusHtml += '<ul class="nav mb-20">';
        $cusHtml += '<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sidebar-setting">Menu </a></li>';
        $cusHtml += '<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#header-setting">Encabezado</a></li>';
        $cusHtml += '</ul>';
        $cusHtml += '<div class="tab-content">';
        $cusHtml += '<div class="tab-pane fade show active" id="sidebar-setting">';
        $cusHtml += '<h5 class="mb-20">Elegir un Tema</h5>';
        $cusHtml += '<button class="cus-radio light" data-target="side-header" onclick="_cambiarSidebar(1)"  data-color="light"><i class="icon"></i>light</button>';
        $cusHtml += '<button class="cus-radio dark active" data-target="side-header" onclick="_cambiarSidebar(2)" data-color="dark"><i class="icon"></i>dark</button>';
        $cusHtml += '<button class="cus-radio primary" data-target="side-header" onclick="_cambiarSidebar(3)" data-color="primary"><i class="icon"></i>primary</button>';
        $cusHtml += '<button class="cus-radio secondary" data-target="side-header" onclick="_cambiarSidebar(4)" data-color="secondary"><i class="icon"></i>secondary</button>';
        $cusHtml += '<button class="cus-radio indigo" data-target="side-header" onclick="_cambiarSidebar(5)" data-color="indigo"><i class="icon"></i>indigo</button>';
        $cusHtml += '<button class="cus-radio purple" data-target="side-header" onclick="_cambiarSidebar(6)" data-color="purple"><i class="icon"></i>purple</button>';
        $cusHtml += '<button class="cus-radio pink" data-target="side-header" onclick="_cambiarSidebar(7)" data-color="pink"><i class="icon"></i>pink</button>';
        $cusHtml += '<button class="cus-radio red" data-target="side-header" onclick="_cambiarSidebar(8)" data-color="red"><i class="icon"></i>red</button>';
        $cusHtml += '<button class="cus-radio brown" data-target="side-header" onclick="_cambiarSidebar(9)" data-color="brown"><i class="icon"></i>brown</button>';
        $cusHtml += '<button class="cus-radio orange" data-target="side-header" onclick="_cambiarSidebar(10)" data-color="orange"><i class="icon"></i>orange</button>';
        $cusHtml += '<button class="cus-radio green" data-target="side-header" onclick="_cambiarSidebar(11)" data-color="green"><i class="icon"></i>green</button>';
        $cusHtml += '</div>';
        $cusHtml += '<div class="tab-pane fade" id="header-setting">';
        $cusHtml += '<h5 class="mb-20">Color de Encabezado</h5>';
        $cusHtml += '<button class="cus-radio light active" onclick="_cambiarHeader(1)" data-target="header-top" data-color="light"><i class="icon"></i>light</button>';
        $cusHtml += '<button class="cus-radio dark" data-target="header-top" onclick="_cambiarHeader(2)" data-color="dark"><i class="icon"></i>dark</button>';
        $cusHtml += '<button class="cus-radio primary" data-target="header-top" onclick="_cambiarHeader(3)" data-color="primary"><i class="icon"></i>primary</button>';
        $cusHtml += '<button class="cus-radio secondary" data-target="header-top" onclick="_cambiarHeader(4)" data-color="secondary"><i class="icon"></i>secondary</button>';
        $cusHtml += '<button class="cus-radio indigo" data-target="header-top" onclick="_cambiarHeader(5)" data-color="indigo"><i class="icon"></i>indigo</button>';
        $cusHtml += '<button class="cus-radio purple" data-target="header-top" onclick="_cambiarHeader(6)" data-color="purple"><i class="icon"></i>purple</button>';
        $cusHtml += '<button class="cus-radio pink" data-target="header-top" onclick="_cambiarHeader(7)" data-color="pink"><i class="icon"></i>pink</button>';
        $cusHtml += '<button class="cus-radio red" data-target="header-top" onclick="_cambiarHeader(8)" data-color="red"><i class="icon"></i>red</button>';
        $cusHtml += '<button class="cus-radio brown" data-target="header-top" onclick="_cambiarHeader(9)" data-color="brown"><i class="icon"></i>brown</button>';
        $cusHtml += '<button class="cus-radio orange" data-target="header-top" onclick="_cambiarHeader(10)" data-color="orange"><i class="icon"></i>orange</button>';
        $cusHtml += '<button class="cus-radio green" data-target="header-top" onclick="_cambiarHeader(11)" data-color="green"><i class="icon"></i>green</button>';
        $cusHtml += '</div>';
        $cusHtml += '<div class="tab-pane fade" id="primary-setting">';
        $cusHtml += '<h5 class="mb-20">Color primario</h5>';
